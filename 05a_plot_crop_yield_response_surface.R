...
ozone <- qread("E:/data/impacts_ozone_AOT40_5.qs", nthreads = qn)
...
Faod <- read.csv("E:/figures/crop/P6/Faod_Maize_data.csv")
ozone <- read.csv("E:/figures/crop/P6/O3_Maize_data.csv")
